...
<body>
            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav">
                        ...
                        <li class="login"><a href="http://webmail.artecsolar.com.br" target="_blank"
                                title="Acessar WebMail"><i class="fa fa-envelope"></i></a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div>
        </div>
    ...
    <section id="contact-page" class="container">
        <iframe
            src="https://docs.google.com/forms/d/e/1FAIpQLSdn7gWHTKLupjXQSngLCGlmfe9lRzElJjc4x_kI8ZuRv7MyQA/viewform?embedded=true"
